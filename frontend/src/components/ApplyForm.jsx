...
//     <Container>
//       <Row>
//       <h1 className="Job-Titels">Apply for {job.title}</h1>
//       <h1 className="Description-Titel">Description:</h1>
...
//         </Form.Group>
//         <Form.Group className="FormApply">
...
//             <Row className="skillrow">
//               {job.skills.map((skill, index) => (
//                 <Col key={`skill-${index}`} xs={12} md={6}>
//                   <li>
//                     <Form.Check 
//                       type="checkbox" 
//                       label={skill}
...
//             <Row className="skillrow">
//               {job.requirements.map((requirement, index) => (
//                 <Col key={`requirement-${index}`} xs={12} md={6}>
//                   <li>
//                     <Form.Check 
//                       type="checkbox" 
//                       label={requirement}
